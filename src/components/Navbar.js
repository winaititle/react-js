...
const pages = [
    ...
    ,
    {
        title: 'MY COURSES', icon: '', to: '/mycourses'
    },
...
const settings = [
    ...
    {
        title: 'Logout', icon: '', to: '/dashboard'
    }
]
        ...
        <AppBar position="static" style={{ backgroundColor: '#DE8976' }}>
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    >
                        <IconButton>
                            <Avatar alt="Remy Sharp" src="https://logodix.com/logo/1725234.png" />
                        </IconButton>
                    </Typography>
                    {/* /LOGO */}
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        <Tooltip title="Open settings">
                            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                <Avatar alt="Remy Sharp" src="https://static1.cbrimages.com/wordpress/wp-content/uploads/2022/06/gojo2.jpg" />
                            </IconButton>
                        </Tooltip>
                        <Menu
                            sx={{ mt: '45px' }}
                    ...
                    {/* /User Menu */}
                    <Button icon ="" variant="" onClick={handleLogout}>ออกจากระบบ</Button>           
